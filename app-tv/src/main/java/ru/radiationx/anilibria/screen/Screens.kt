...
import ru.radiationx.anilibria.screen.search.content.ContentSearchFragment
import ru.radiationx.anilibria.screen.search.content.ContentSearchType
import ru.radiationx.anilibria.screen.player.content.ContentPlayerFragment
import ru.radiationx.anilibria.screen.player.content.ContentEpisodesFragment
...
class MovieDetailsScreen(private val tmdbId: Int) : FragmentScreen {
    override fun createFragment(factory: FragmentFactory): Fragment {
        return ru.radiationx.anilibria.screen.moviedetails.MovieDetailsFragment.newInstance(tmdbId)
    }
}

class TvSeriesDetailsScreen(private val tmdbId: Int) : FragmentScreen {
    override fun createFragment(factory: FragmentFactory): Fragment {
        return ru.radiationx.anilibria.screen.tvseriesdetails.TvSeriesDetailsFragment.newInstance(tmdbId)
    }
}
...
class ContentPlayerScreen(
    ...
    override fun createFragment(factory: FragmentFactory): Fragment {
        val type = if (isMovie) {
            ru.radiationx.anilibria.screen.player.content.PlayerContentType.MOVIE
        } else {
            ru.radiationx.anilibria.screen.player.content.PlayerContentType.TV_SERIES
        }
        return ru.radiationx.anilibria.screen.player.content.ContentPlayerFragment.newInstance(
            tmdbId,
            type,
            season,
            episode
...
) : ru.radiationx.anilibria.common.fragment.GuidedAppScreen() {
    override fun createFragment(factory: FragmentFactory): ru.radiationx.anilibria.common.fragment.FakeGuidedStepFragment {
