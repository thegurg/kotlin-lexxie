package ru.radiationx.lexxie.contentprovider.suggestions
...
import ru.radiationx.lexxie.App
import ru.radiationx.lexxie.contentprovider.SystemSuggestionEntity
...
class SuggestionsContentProvider : ContentProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "ru.radiationx.lexxie.contentprovider.suggestions"
