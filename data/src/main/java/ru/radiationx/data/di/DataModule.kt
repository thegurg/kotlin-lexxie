...
import ru.radiationx.data.di.providers.TmdbClientWrapper
import ru.radiationx.data.di.providers.TmdbNetworkClient
import ru.radiationx.data.di.providers.TmdbOkHttpProvider
...
class DataModule(context: Context) : QuillModule() {
    ...
    init {
        ...
        single<TmdbOkHttpProvider>()

single<SimpleClientWrapper>()
        single<ApiClientWrapper>()
        single<TmdbClientWrapper>()
        ...
        singleImpl<IClient, TmdbNetworkClient>(TmdbClient::class)
